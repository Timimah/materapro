...
import Why1 from "@assets/website/home1.jpg"
import Why2 from "@assets/website/home2.jpg"
import Apart1 from "@assets/website/home3.webp"
import Apart2 from "@assets/website/home4.webp"
  ...
  return (
    <div className='mx-auto text-lnblack'>
        ...
        <div className='flex flex-col md:flex-row items-center justify-between gap-8 md:gap-20 min-h-screen md:h-screen md:py-100 py-20'>
          <div className='md:h-full flex flex-col justify-end items-end flex-1/3 px-8 md:px-0 md:-mr-10'>
            <img
              src={Why2}
              alt=''
              className='rounded-2xl lg:rounded-r-2xl md:-ml-20 w-90 h-80 object-cover shadow-lg'
            />
          </div>
          ...
          <div className='md:h-full flex flex-col justify-center md:justify-start flex-1/3 px-8 md:px-0 md:-ml-5'>
            <img
              src={Why1}
              alt=''
              className='rounded-2xl md:rounded-l-2xl w-full h-80 object-cover shadow-lg'
            />
          </div>
        </div>
      </motion.section>
      ...
      >
        ...
        <div className='h-60 flex items-center md:mt-35'>
          <div className='-rotate-12 flex items-center justify-center w-42 h-52 md:w-92 md:h-92 bg-white rounded-2xl border border-gray shadow-md z-10'>
            <img
              src={Apart2}
              alt=''
              className='w-40 h-50 md:w-90 md:h-90 object-cover rounded-xl shadow-lg'
            />
          </div>
          <div className='rotate-12 flex items-center justify-center w-42 h-52 md:w-92 md:h-92 bg-white rounded-2xl border border-gray md z-10'>
            <img
              src={Apart1}
              alt=''
              className='w-40 h-50 md:w-90 md:h-90 object-cover rounded-xl shadow-lg'
